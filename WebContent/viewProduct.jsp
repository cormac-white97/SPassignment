...
<div id="w3lDemoBar" class="w3l-demo-bar">
	...
	</a> <a href="https://w3layouts.com/?p=22079" class="w3l-buy" ga-on="click"
		ga-event-category="Grocery Store Template" ga-event-action="Buy Now"
		ga-event-label="Grocery Store - Buy"
		title="Remove Backlink from template"> <span class="w3l-icon -buy">
